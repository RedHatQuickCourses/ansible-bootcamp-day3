...
execute_init()
{
	...
	sed -i "s/ansible-bootcamp-day3/${REPONAME}/g" *.* > /dev/null 2>&1
	sed -i "s/ansible-bootcamp-day3/${REPONAME}/g" supplemental-ui/partials/header-content.hbs > /dev/null 2>&1
	echo -e "done"
